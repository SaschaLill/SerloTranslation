...
temp = temp.replace("Körpers ", "field ")
temp = temp.replace("Körper ", "field ")
temp = temp.replace("Vektorräumen", "vector spaces")
...
temp = temp.replace("linearer", "linear")
...
temp = temp.replace("Unabhängigkeit", "independence")
temp = temp.replace("linear unabhängigen", "linearly independent")
temp = temp.replace("linear unabhängiger", "linearly independent")
temp = temp.replace("linear unabhängige", "linearly independent")
temp = temp.replace("linear unabhängig", "linearly independent")
temp = temp.replace("Abbildungen", "maps")
temp = temp.replace("Abbildung", "map")
temp = temp.replace("Fortsetzungen", "continuations")
temp = temp.replace("Fortsetzung", "continuation")

temp = temp.replace("Austauschlemmas", "exchange lemma")
temp = temp.replace("Austauschlemma", "exchange lemma")
temp = temp.replace("Additivität", "additivity")
temp = temp.replace("Homogenität", "homogeneity")
temp = temp.replace("Verträglichkeit", "compatibility")

temp = temp.replace("Erzeugendensystemen", "generators")
temp = temp.replace("Erzeugendensysteme", "generators")
temp = temp.replace("Erzeugendensysteme", "generator")
temp = temp.replace("Erzeugendensystem", "generator")
...
temp = temp.replace("Skalarmultiplikation", "scalar multiplication")
temp = temp.replace("skalare Multiplikation", "scalar multiplication")
temp = temp.replace("Vektoraddition", "vector addition")
temp = temp.replace("Distributivgesetzes", "distributive law")
temp = temp.replace("Distributivgesetz", "distributive law")
temp = temp.replace("Assoziativgesetzes", "associative law")
temp = temp.replace("Assoziativgesetz", "associative law")
temp = temp.replace("Kommutativgesetzes", "commutative law")
temp = temp.replace("Kommutativgesetz", "commutative law")
...
temp = temp.replace("Vektors", "vector")
temp = temp.replace("Vektor", "vector")
